...
# Proposal narrative: Transparent and Reproducible Research with R AERA
...
presenters have partnered with DataCamp (https://www.datacamp.com) through the
use of an academic account to provide a platform for less experienced users to
get "up to speed" prior to the training. DataCamp is an online learning platform
...
### Conducting reproducible research Considerable recent attention has been
